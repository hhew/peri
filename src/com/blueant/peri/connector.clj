(ns com.blueant.peri.connector
  "Defines the connector configuration for the com.blueant/peri project."
  (:require [io.pedestal.connector :as connector]
            ...
            [com.blueant.peri.routes :as routes]))

(defn connector-map
  "Creates a connector map for the com.blueant/peri service.
