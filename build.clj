...
(defn- pom-template [version]
  [[:description "FIXME: generated by the io.pedestal/embedded template."]
   [:url "https://github.com/blueant/peri"]
   [:licenses
    [:license
   ...
   [:scm
    [:url "https://github.com/blueant/peri"]
    [:connection "scm:git:https://github.com/blueant/peri.git"]
    [:developerConnection "scm:git:ssh:git@github.com:blueant/peri.git"]
    [:tag (str "v" version)]]])
